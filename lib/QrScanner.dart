...
class _QRScanState extends State<QRScan> {
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        child: Icon(Icons.flash_on, color: Colors.white), // icon of the button
                      ...
                      ElevatedButton(
                        ...
                        child: Icon(Icons.camera_front_rounded, color: Colors.white), // icon of the button
                        style: ElevatedButton.styleFrom( // styling the button
                          shape: CircleBorder(),
                          padding: EdgeInsets.all(10),
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      setState(() {
        result = scanData;
        Get.to(ModelView(name: result!.code.toString()));
      });
